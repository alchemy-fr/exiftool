...
MIE, MIFF, MNG, MPC, MPEG, MPF, MXF, MakerNotes, Matroska, Meta, Ogg, PDF,
PICT, PNG, PSP, PhotoMechanic, Photoshop, PostScript, PrintIM, QuickTime,
RAF, RIFF, RSRC, RTF, Rawzor, Real, SVG, SigmaRaw, Stim, Theora, Vorbis,
XML, XMP, ZIP
...
NikonScan, Ocad, Ogg, Olympus, PDF, PICT, PNG, PSP, Panasonic, Pentax,
PhotoMechanic, Photoshop, PictureInfo, PostScript, PreviewIFD, PrintIM,
ProfileIFD, QuickTime, RAF, RAF2, RIFF, RMETA, RSRC, RTF, Rawzor, Real,
...
for EXIF, IPTC, XMP, PNG, ID3, PDF, Photoshop, QuickTime, MIE and Vorbis
information:
